...
//                       type="checkbox"
//                       required
//                       className="mt-0.5 h-4 w-4 rounded-md border-gray-300 dark:border-white/20 text-amber-500 focus:ring-amber-400/20 focus:ring-offset-0 bg-white/80 dark:bg-white/5 cursor-pointer"
//                     />
//                     <span className="text-[13px] text-gray-400 dark:text-white/35 leading-relaxed">
//                       I agree to the{' '}
//                       <a
//                         href="#"
//                         className="text-amber-600 dark:text-amber-500/75 hover:underline font-medium"
...
//                   className="flex-1 h-12 rounded-xl font-semibold text-white border-0 transition-all duration-200 hover:opacity-90 active:scale-[0.98] disabled:opacity-50"
//                   style={{
//                     background:
//                       'linear-gradient(135deg, #059669 0%, #0891B2 100%)',
//                   }}
