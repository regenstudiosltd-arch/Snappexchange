...
// // src/app/components/pages/RequestsPage.tsx
// 'use client';
...
//         </CardContent>
//       </Card>
//       {/* Accepted & Declined cards unchanged */}
//       <Card>
//         <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
//           <CardTitle className="text-sm font-medium text-muted-foreground">
//             Accepted
...
//   // ✅ Fixed: myGroups is now memoized → stable reference
//   const myGroups = useMemo<Group[]>(() => {
//     return groupsData?.results || groupsData || [];
//   }, [groupsData]);
...
//                 )}
//               </Button>
//               {/* Accepted & Declined buttons unchanged */}
//               <Button
//                 variant={activeTab === 'approved' ? 'default' : 'outline'}
//                 size="sm"
//                 onClick={() => setActiveTab('approved')}
...
//                   onAccept={handleAccept}
//                   onDecline={handleDecline}
//                   // ✅ Fixed: no more ?? false (TS error resolved)
//                   isProcessing={
//                     actionMutation.isPending &&
//                     actionMutation.variables?.id === request.id
//                   }
