// src/app/components/pages/GroupsPage.tsx
...
// // -----------------------------------------------------------------------------
// // Types & Query Keys (consistent with Dashboard & GoalsPage)
// interface Group {
//   id: number;
//   public_id: string;
//   group_name: string;
...
//   // Data fetching with TanStack Query (replaces manual useEffect + useCallback)
//   const {
//     data: groups = [],
//     isLoading,
//     error,
...
//       return response.data?.results || [];
//     },
//     staleTime: 1000 * 60 * 5, // 5 minutes – same policy as Dashboard
//   });

//   // Derived values (never recalculated on every render)
//   const filteredGroups = useMemo(() => {
//     const q = searchQuery.toLowerCase().trim();
//     if (!q) return groups;
//     return groups.filter(
...
//   // Loading skeleton (matches previous pages – much better UX)
//   if (isLoading) {
//     return (
//       <div className="space-y-6 mb-20 md:mb-0">
//         {/* Header skeleton */}
