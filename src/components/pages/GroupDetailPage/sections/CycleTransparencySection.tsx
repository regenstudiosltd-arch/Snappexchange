// src/components/pages/GroupDetailPage/sections/CycleTransparencySection.tsx
...
/**
 * Returns the display name for a payout recipient, appending " (You)" when
 * the recipient is the currently logged-in user.
 */
...
function RecipientCard({
  ...
  const isCurrentUser =
    currentUserId !== null && recipient.user_id === currentUserId;
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        >
          {displayName(recipient.full_name, recipient.user_id, currentUserId)}
        </p>
  ...
  return (
    <div className="rounded-2xl border border-border/50 bg-card shadow-sm overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Payout recipients — names get "(You)" when applicable */}
