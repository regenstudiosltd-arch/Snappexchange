// src/components/pages/GroupDetailPage/sections/ContributionTrackerSection.tsx
...
/**
 * Returns the member's display name, appending " (You)" when the member is
  ...
  return (
    <div
      className={cn(
        ...
        isCurrentUser &&
          'rounded-lg px-2 -mx-2 bg-amber-500/5 dark:bg-amber-500/6',
      )}
    >
      <div className="relative shrink-0">
        <MemberAvatar
          ...
          size="md"
          gradientVariant={
            hasContributed ? (isCurrentUser ? 'amber' : 'cyan') : 'neutral'
          }
        />
        <span
          className={cn(
