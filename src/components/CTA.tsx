...
export function CTA({ onNavigate }: CTAProps = {}) {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-cyan-500 via-cyan-600 to-teal-600 text-white relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto">
            Join thousands of Ghanaians who are building wealth through smart savings. Create your free account in minutes and start saving today.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" variant="secondary" className="bg-white text-cyan-600 hover:bg-gray-100 group" onClick={() => onNavigate?.("signup")}>
              Create Account
