...
const publicGroups = [
  {
    ...
    frequency: "Monthly",
    description: "For tech workers saving towards professional development and business opportunities",
    nextPayout: "15 days",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    frequency: "Monthly",
    description: "Students helping students build financial discipline and savings habits",
    nextPayout: "20 days",
  },
  {
    id: "4",
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>
            {showDetails && selectedGroupData ? "Group Details" : "Join a Savings Group"}
          </DialogTitle>
          <DialogDescription>
            {showDetails ? "Review group information before joining" : "Browse and join public savings groups"}
          </DialogDescription>
        </DialogHeader>
        ...
        {!showDetails ? (
                ...
                >
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-[#059669]">Next: {group.nextPayout}</span>
                    </div>
                  </CardContent>
                </Card>
              ))}
          ...
          <div className="space-y-6 py-4">
            {requestSent ? (
              ...
              <>
                {/* Group Header */}
                <div className="bg-gradient-to-br from-[#DC2626]/10 via-[#F59E0B]/10 to-[#059669]/10 rounded-lg p-6">
                  <h3 className="text-2xl mb-2">{selectedGroupData.name}</h3>
                  <p className="text-muted-foreground">Administered by {selectedGroupData.admin}</p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center p-4 border rounded-lg">
                    ...
                    <div>{selectedGroupData.members}/{selectedGroupData.maxMembers}</div>
                  </div>
                  <div className="text-center p-4 border rounded-lg">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <label className="flex items-start gap-2 cursor-pointer">
                    ...
                    <span className="text-sm text-muted-foreground">
                      I have read and agree to abide by the group rules and contribution schedule. I understand that failure to contribute on time may result in removal from the group.
                    </span>
                  </label>
                </div>
