        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 text-sm">
              ...
              <span className="text-muted-foreground">
                Joined{' '}
                {new Date(mockUserDetails.joinedDate).toLocaleDateString()}
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t">
            <div className="text-center">
              <div className="text-2xl text-cyan-600 mb-1">
                {mockUserDetails.groupsCount}
              </div>
              <div className="text-xs text-muted-foreground">Active Groups</div>
            </div>
            <div className="text-center">
              <div className="text-2xl text-cyan-600 mb-1">
                {mockUserDetails.reliabilityScore}%
              </div>
              <div className="text-xs text-muted-foreground">Reliability</div>
            </div>
            <div className="text-center">
              <div className="text-sm text-cyan-600 mb-1">
                {mockUserDetails.totalContributions}
              </div>
