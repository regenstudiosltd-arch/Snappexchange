        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-100 border border-cyan-200">
              ...
              <span className="text-sm text-cyan-700">Digital Susu Made Simple</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Save individually or in groups with ease. Join thousands of Ghanaians building wealth through our trusted digital susu platform.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-cyan-500 hover:bg-cyan-600 group" onClick={() => onNavigate?.("signup")}>
                Get Started
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-gradient-to-r from-cyan-400 via-teal-500 to-cyan-600 rounded-2xl opacity-20 blur-2xl" />
